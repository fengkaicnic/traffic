...
class Connection(object):
    ...
    def create_consumer(self, topic, proxy, fanout=False):
        ...
        :param topic: This is a name associated with what to consume from.
                      ...
                      topic. For example, all instances of traffic-compute consume
...
class CommonRpcContext(object):
    ...
    def elevated(self, read_deleted=None, overwrite=False):
        ...
        # TODO(russellb) This method is a bit of a traffic-ism.  It makes
        # some assumptions about the data in the request context sent
        # across rpc, while the rest of this class does not.  We could get
        # rid of this if we changed the traffic code that uses this to
        # convert the RpcContext back to its native RequestContext doing
        # something like traffic.context.RequestContext.from_dict(ctxt.to_dict())
