...
Functions in this module are imported into the traffic.db namespace. Call these
functions from traffic.db namespace, not the traffic.db.api namespace.
...
:sql_connection:  string specifying the sqlalchemy connection to use, like:
                  `sqlite:///var/lib/traffic/traffic.sqlite`.
...
def tqdisc_get_by_ip(context, ip):
    return IMPL.tqdisc_get_by_ip(context, ip)
...
def tfilter_delete(context, id):
    'delete a '
    return IMPL.tfilter_delete(context, id)
...
def instance_count_all(context):
    return IMPL.instance_count_all(context)

#add by weiyuanke@cnic.cn
def instance_count_by_filters(context, **kwargs):
    return IMPL.instance_count_by_filters(context, **kwargs)
...
def instance_get_all_by_filters(context, filters, sort_key='created_at',
    ...
    return IMPL.instance_get_all_by_filters(context, filters, sort_key,
                                            sort_dir, limit=limit, marker=marker, page_index=page_index)


def instance_get_active_by_window(context, begin, end=None, project_id=None,
                                  host=None, limit=None, page_index=None, user_id=None):
    ...
    return IMPL.instance_get_active_by_window(context, begin, end,
                                              project_id, host, limit=limit, page_index=page_index, user_id=user_id)
...
def instance_get_active_by_window_joined(context, begin, end=None,
    ...
    return IMPL.instance_get_active_by_window_joined(context, begin, end,
                                              project_id, host, limit=limit, page_index=page_index)
...
def update_instance_cdrom_active(context, instance_uuid, cdrom_active):
    """Update the CDROM active info."""
    return IMPL.update_instance_cdrom_active(
        context, instance_uuid, cdrom_active)
...
def instance_type_get_max_flavor_id(context):
    """Get instance type by flavor id."""
    return IMPL.instance_type_get_max_flavor_id(context)
