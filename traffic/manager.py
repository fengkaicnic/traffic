...
class Manager(base.Base):
    ...
    def load_plugins(self):
        pluginmgr = pluginmanager.PluginManager('traffic', self.__class__)
...
class SchedulerDependentManager(Manager):
    ...
    def load_plugins(self):
        pluginmgr = pluginmanager.PluginManager('traffic', self.service_name)
        pluginmgr.load_plugins()
    ...
    def _publish_service_capabilities(self, context):
        ...
        if self.last_capabilities:
            ...
            for capability_item in self.last_capabilities:
                self.scheduler_rpcapi.update_service_capabilities(context, self.service_name, self.host, capability_item)
